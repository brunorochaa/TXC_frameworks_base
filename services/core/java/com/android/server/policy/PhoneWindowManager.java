    ...
    public void sendCustomAction(Intent intent) {
        ...
        if (action != null) {
            if (ActionHandler.INTENT_SHOW_POWER_MENU.equals(action)) {
                showGlobalActions();
            } else if (GzospUtils.INTENT_SCREENSHOT.equals(action) || ActionHandler.INTENT_SCREENSHOT.equals(action)) {
                ...
                mScreenshotRunnable.setScreenshotType(TAKE_SCREENSHOT_FULLSCREEN);
                mHandler.post(mScreenshotRunnable);
            } else if (GzospUtils.INTENT_REGION_SCREENSHOT.equals(action) || ActionHandler.INTENT_REGION_SCREENSHOT.equals(action)) {
                mContext.enforceCallingOrSelfPermission(Manifest.permission.ACCESS_SURFACE_FLINGER, TAG + "sendCustomAction permission denied");
                mHandler.removeCallbacks(mScreenshotRunnable);
